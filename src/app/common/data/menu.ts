...
export const verticalMenuItems = [
    new Menu(1, 'Dashboard', '/d2e/dashboard', null, 'dashboard', null, false, 0),
    ...
    // D2E Clinical
    new Menu(301, 'Activity Board', '/d2e/activity', null, 'grid_view', null, false, 0),
    new Menu(302, 'Alerts & Reports', '/d2e/alerts', null, 'notifications', null, false, 0),
    new Menu(303, 'Providers', '/d2e/providers', null, 'medical_services', null, false, 0),
    new Menu(304, 'Referral Dashboard', '/d2e/referral', null, 'person_search', null, false, 0),
    new Menu(305, 'Documents', '/d2e/documents', null, 'folder', null, false, 0),
    new Menu(306, 'Hospital Systems', '/d2e/hospital-systems', null, 'business', null, false, 0),
    new Menu(307, 'Clients', '/d2e/clients', null, 'groups', null, false, 0),
    new Menu(308, 'Patients', '/d2e/patients', null, 'personal_injury', null, false, 0),
    new Menu(309, 'Appointments', '/d2e/appointments', null, 'event', null, false, 0),
    new Menu(310, 'Intake', '/d2e/intake', null, 'assignment', null, false, 0),
    // new Menu(311, 'Referral Dashboard 2', '/d2e/referral-2', null, 'dashboard_customize', null, false, 0),
]
...
export const horizontalMenuItems = [
    ...
    // D2E Clinical
    new Menu(300, 'D2E Clinical', null, null, 'local_hospital', null, true, 0),
    new Menu(301, 'Activity Board', '/d2e/activity', null, 'grid_view', null, false, 300),
    new Menu(302, 'Alerts & Reports', '/d2e/alerts', null, 'notifications', null, false, 300),
    new Menu(303, 'Providers', '/d2e/providers', null, 'medical_services', null, false, 300),
    new Menu(304, 'Referral Dashboard', '/d2e/referral', null, 'person_search', null, false, 300),
    new Menu(305, 'Documents', '/d2e/documents', null, 'folder', null, false, 300),
    new Menu(309, 'Appointments', '/d2e/appointments', null, 'event', null, false, 300),
    new Menu(310, 'Intake', '/d2e/intake', null, 'assignment', null, false, 300),
    new Menu(311, 'Referral Dashboard 2', '/d2e/referral-2', null, 'dashboard_customize', null, false, 300),
]